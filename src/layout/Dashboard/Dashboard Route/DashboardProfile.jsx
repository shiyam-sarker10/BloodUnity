...
//   userINfo fetching 
  ...
  return (
    <div className=" lg:flex h-screen px-4 md:px-8 items-center justify-between  ">
      {isLoading ? (
        ...
        <div className="flex flex-col py-10 md:py-0  justify-center items-center lg:w-[40%] ">
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-4 ">
            <p className=" text-lg w-max">
              Name :{" "}
              <span className="text-gray-500 text-base">{UserInfo?.name}</span>
            </p>
            <p className=" text-lg w-max">
              Email :{" "}
              <span className="text-gray-500 text-base">{UserInfo?.email}</span>
            </p>
            <p className=" text-lg w-max">
              Role :{" "}
              <span className="text-gray-500 text-base">{UserInfo?.role}</span>
            </p>
            <p className=" text-lg w-max">
              BloodGroup :{" "}
